<div class="modal fade" id="agregarCfdiDialog" tabindex="-1">
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<g:uploadForm name="uploadCfdi" class="form" action="agregarCfdi" >
				<div class="modal-body">
					
					<div class="form-group">
					    <label for="inputFile">Comprobante fiscal digital CFDI</label>
					    <input type="file" id="inputFile" name="xml" accept="application/xml" autocomplete="off">
